...
class Dataset(MajorObject):
    ...
    def CreateLayerFromGeomFieldDefn(self, *args) -> "OGRLayerShadow *":
...
class RasterAttributeTable(object):
    ...
    def ReadValuesIOAsString(self, *args) -> "CPLErr":
    ...
    def ReadValuesIOAsInteger(self, *args) -> "CPLErr":
    ...
    def ReadValuesIOAsDouble(self, *args) -> "CPLErr":
    ...
    def RemoveStatistics(self, *args) -> "void":
...
def CreateRasterAttributeTableFromMDArrays(*args) -> "GDALRasterAttributeTableShadow *":
...
def IsLineOfSightVisible(*args, **kwargs) -> "int *":
    r"""
...
def TileIndexInternalNames(*args) -> "GDALDatasetShadow *":
