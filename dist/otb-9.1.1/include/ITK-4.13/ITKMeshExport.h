...
#      define ITKMesh_EXPORT __attribute__((visibility("default")))
#    else
...
#    define ITKMesh_HIDDEN __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef ITKMESH_DEPRECATED
#  define ITKMESH_DEPRECATED __attribute__ ((__deprecated__))
#endif
