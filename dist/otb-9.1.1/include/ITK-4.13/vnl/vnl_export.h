...
#      define VNL_EXPORT __attribute__((visibility("default")))
#    else
...
#    ifdef itkvnl_EXPORTS
        /* We are building this library */
#      define VNL_TEMPLATE_EXPORT __attribute__((visibility("default")))
#    else
        /* We are using this library */
#      define VNL_TEMPLATE_EXPORT __attribute__((visibility("default")))
#    endif
...
#    define VNL_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif
