...
# User Options
#-----------------------------------------------------------------------------
set (${HDF4_PACKAGE_NAME}_BUILD_FORTRAN   OFF)
...
set (${HDF4_PACKAGE_NAME}_EXPORT_LIBRARIES xdr-static;xdr-shared;dfalt-static;dfalt-shared;mfhdfalt-static;mfhdfalt-shared)
...
set (${HDF4_PACKAGE_NAME}_SHARE_DIR "${PACKAGE_PREFIX_DIR}/share/cmake")
...
if (NOT TARGET "hdf4")
  ...
  include (${PACKAGE_PREFIX_DIR}/share/cmake/hdf4/hdf4-targets.cmake)
endif ()
