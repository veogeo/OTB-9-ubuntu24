...
def _UseExceptions() -> "void":
    r"""_UseExceptions()"""
    return _gdal_array._UseExceptions()

def _DontUseExceptions() -> "void":
    r"""_DontUseExceptions()"""
    return _gdal_array._DontUseExceptions()

def _UserHasSpecifiedIfUsingExceptions() -> "int":
...
def AddNumpyArrayToDict(dict: "PyObject *", schemaField: "ArrowSchema const *", arrayField: "ArrowArray const *", osPrefix: "std::string const &", pointerArrayKeeper: "PyObject *") -> "bool":
