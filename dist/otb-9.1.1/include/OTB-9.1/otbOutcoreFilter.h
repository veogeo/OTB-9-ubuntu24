...
#ifndef otbOutcoreFilter_h
#define otbOutcoreFilter_h
...
public:
  ...
  using Superclass   = UnaryFunctorNeighborhoodImageFilter<
  ...
  itkTypeMacro(OutcoreFilter, SuperClass);
