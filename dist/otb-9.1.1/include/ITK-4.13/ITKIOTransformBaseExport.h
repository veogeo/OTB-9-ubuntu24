...
#      define ITKIOTransformBase_EXPORT __attribute__((visibility("default")))
#    else
...
#    define ITKIOTransformBase_HIDDEN __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef ITKIOTRANSFORMBASE_DEPRECATED
#  define ITKIOTRANSFORMBASE_DEPRECATED __attribute__ ((__deprecated__))
#endif
