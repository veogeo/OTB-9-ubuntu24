...
cmake "../${OTB_PKG}/SuperBuild" \
  ...
  -DOTB_BUILD_OTBImageManipulation \
  -DOTB_BUILD_OTBImageStatistics \
  -DOTB_BUILD_OTBMathParser \
  -DOTB_BUILD_OTBProjection \
  -DOTB_BUILD_OTBTransform \
  -DOTB_BUILD_OTBAppImageUtils \
  -DOTB_BUILD_OTBAppMathParser \
  -DOTB_BUILD_OTBAppProjection \
  -DOTB_BUILD_OTBSAR \
  -DOTB_BUILD_OTBVectorDataProcessing \
  -DOTB_BUILD_OTBPointSet \
  -DOTB_BUILD_OTBImageClassification \
