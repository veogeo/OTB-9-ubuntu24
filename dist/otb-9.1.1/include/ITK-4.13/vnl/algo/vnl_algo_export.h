...
#  define VNL_ALGO_TEMPLATE_EXPORT
#  define VNL_ALGO_NO_EXPORT
#else
#  ifndef VNL_ALGO_EXPORT
#    ifdef itkvnl_algo_EXPORTS
        /* We are building this library */
#      define VNL_ALGO_EXPORT __attribute__((visibility("default")))
#    else
...
#  ifndef VNL_ALGO_TEMPLATE_EXPORT
#    ifdef itkvnl_algo_EXPORTS
        /* We are building this library */
#      define VNL_ALGO_TEMPLATE_EXPORT __attribute__((visibility("default")))
#    else
        /* We are using this library */
#      define VNL_ALGO_TEMPLATE_EXPORT __attribute__((visibility("default")))
#    endif
...
#    define VNL_ALGO_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef VNL_ALGO_DEPRECATED
#  define VNL_ALGO_DEPRECATED __attribute__ ((__deprecated__))
#endif
