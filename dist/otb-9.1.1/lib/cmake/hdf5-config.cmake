...
set (${HDF5_PACKAGE_NAME}_ENABLE_Z_LIB_SUPPORT ON;–DH5_USE_110_API:BOOL=ON)
...
if (${HDF5_PACKAGE_NAME}_BUILD_JAVA)
  set (${HDF5_PACKAGE_NAME}_JAVA_INCLUDE_DIRS
      ${PACKAGE_PREFIX_DIR}/lib/jarhdf5-1.12.3.jar
...
# Version Strings
#-----------------------------------------------------------------------------
set (${HDF5_PACKAGE_NAME}_VERSION_STRING 1.12.3)
